...
import 'package:v4/pages/Dashboard.dart';
import 'package:v4/providers/UserProvider.dart';
import 'package:v4/theme/Style.dart';
import 'package:v4/theme/colors.dart';
import 'package:v4/widget/Buttons.dart';
import 'package:v4/widget/inputbox.dart';
import 'package:v4/widget/snackbar.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            PrimaryButton(
                  ...
                  if (_pickedImage == null ||
                    ...
                    if (_pickedImage != null) {
                      CustomSnackBar(
                              ...
                              isfloating: false,
                              scaffoldKey: scaffoldKey,
                              title: "Please fillup all details!", onPressed: (){})
                          .show();
                    }
                  } else {
                    if (!RegExp(
              ...
              height: 55, fontsize: 20, borderRadius: 20, width: 100,
            ),
          ],
        ),
      ),
